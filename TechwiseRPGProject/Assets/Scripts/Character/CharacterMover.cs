...
public class CharacterMover 
{
    ...
    {
    if (direction.IsBasic() && isMoving==false && !Map.OccupiedCells.Contains(character.currentCell + direction))
        {
    ...
    public IEnumerator Co_Move(Vector2Int direction)
    {
        ...
        Vector2Int startingCell = character.currentCell;
        ...
        Map.OccupiedCells.Add(character.currentCell + direction); //adding cell we move to occupied cells. 
        Map.OccupiedCells.Remove(character.currentCell); //removing old cell
